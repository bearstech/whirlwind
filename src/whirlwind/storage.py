...
class Store:
    ...
    It uses a list of Finders to find nodes.
    """
...
class FindQuery:
    ...
    def __repr__(self):
        ...
        return '<FindQuery: %s from %s until %s>' % (self.pattern,
...
finders = [
    ...
    StandardFinder("/tmp/")#settings.STANDARD_DIRS),
]
